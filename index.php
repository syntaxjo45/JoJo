...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/css/jo-testi.css">
      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="#"><img class="img-fluid" src="assets/img/logovave.png" alt="" width="70px"/></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form style="text-align: center;"><a class="btn btn-light rounded-pill shadow fw-bold" id="testeSWAL" role="button"> <li class="fa fa-button"></li><i class="fas fa-trophy"></i> Top Mentor Titanium</a></form>
          </div>
        </div>
      </nav>
      ...
      <section class="py-5">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-5 text-center text-md-start pt-6">
              <h3 id="vave" class="mb-4 display-2 fw-bold">VAVE <br class="d-block d-lg-none d-xl-block" />#BERBAGI<br/>#CASHBACK</h3>
