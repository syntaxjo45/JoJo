        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-5 text-center text-md-start pt-5 pt-md-9">
              <h3 class="mb-4 display-2 fw-bold">VAVE <br class="d-block d-lg-none d-xl-block" />#BERBAGI<br/>#CASHBACK</h3>
            ...
            <div class="col-md-6 mb-5">
              <div class="card px-5 px-md-3 py-lg-5">
                <div class="row flex-center">
                  ...
                  <div class="col-md-4 pe-0 pe-md-0 text-center"><img class="img-fluid" src="assets/img/illustrations/cashback.jpg" alt="" /></div>
                  <div class="col-md-8 ps-md-3 pe-md-2 text-center text-md-start z-index-2">
                    <div class="card-body px-0">
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100 py-3">
                      <div class="card-body my-2">
                        <div class="d-flex align-items-center"><img class="img-fluid me-3 me-md-2 me-lg-3" src="https://developers.google.com/search/images/google-search-central-logo.png" width="70" alt="" />
                          <div class="flex-1 align-items-center">
                            <h6 class="mb-0 fs--1 text-1000 fw-medium">Jonathan S </h6>
                            <p class="fs--2 fw-normal text-info mb-0">jonathan.com</p>
                          </div>
                        </div>
                        <p class="card-text ps-7 ps-md-0 ps-xl-7 pt-md-4 pt-lg-3 pt-xl-0">“kalao ngantuk ya tidur cuy”.</p>
                      </div>
                    </div>
                  </div>
