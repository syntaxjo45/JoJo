            ...
            <div class="col-auto text-center my-4">
              ...
              <div class="card mb-3 bg-soft-success rounded-3">
                <div class="row g-0 align-items-center">
                  ...
                  <br/>
                  <p style="font-size: 1em;">Menjadi Sebuah Perusahaan Yang Terkemuka Asal Indonesia Yang Memberikan Solusi Untuk Meningkatkan Kesejahteraan Ekonomi Kepada Masyarakat Luas Di Indonesia<p>
                  </div>
                  <div class="col-md-7 col-lg-6 px-md-2 px-xl-6 text-center text-md-start">
                    <div class="card-body px-4 py-5 p-lg-3 p-md-4">
                        <ul>
                        <p class="card-text" style="font-size: 1em;"><li>Meningkatkan Kesejahteraan Masyarakat Indonesia Secara Bersama Dalam Komunitas</li><br> <li>Memberikan Peluang Dan Kemudahan Dalam Berwirausaha Bagi Setiap Anggota</li><br><li>Menjadikan Komunitas Sebagai Pilar Ekonomi Bersama</li><br><li>Meningkatkan Peran Serta Komunitas Dalam Kegiatan Sosial Bersama</li><br><li>Meningkatkan Keadilan Dalam Berusaha Kepada Masyarakat Luas</p>
                        </ul>
                    </div>
                  </div>
                </div>
