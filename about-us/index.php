            ...
            <div class="card bg-soft-success rounded-3">
              <div class="row g-0 align-items-center">
                <div class="col-md-5 col-lg-6 text-md-center">
                  <br />
                  <p style="font-size: 1em;">Menjadi Sebuah Perusahaan Yang Terkemuka Asal Indonesia Yang Memberikan Solusi Untuk Meningkatkan Kesejahteraan Ekonomi Kepada Masyarakat Luas Di Indonesia
                  <p>
                </div>
                  ...
                  <div class="card-body px-4 py-5 p-lg-3 p-md-4">
                    <ul>
                      <p class="card-text" style="font-size: 1em;">
                        ...
                        <li>Meningkatkan Keadilan Dalam Berusaha Kepada Masyarakat Luas
                      </p>
                    </ul>
                  </div>
                </div>
